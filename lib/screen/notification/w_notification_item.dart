          ...
          children:[
            Row(
              children: [
                ...
                emptyExpanded,
                timeago.format(widget.notification.time,locale: context.locale.languageCode).text.size(12).color(context.appColors.lessImportant).make(),
                width10,
              ],
            ),
